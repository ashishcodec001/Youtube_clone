            ...
            <div class="main-section">
                <div class="main-left">
                    ...
                    <button class="yt-side-button">
                        ...
                        <span class="side-channel-label">Ashish chanchlani</span>
                    </button>
                    <button class="yt-side-button">
                        <img src={avtar} height={'30px'} width={'30px'}></img>
                        <span class="side-channel-label">TVF</span>
                    </button>
                    <button class="yt-side-button">
                        <img src={tseries} height={'30px'} width={'30px'}></img>
                        <span class="side-channel-label">cinema</span>
                    </button>
                    <button class="yt-side-button">
                        <img src={avtar} height={'30px'} width={'30px'}></img>
                        <span class="side-channel-label">R2F</span>
                    </button>
                </div>
